...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('dobby_navigation2')
...
# def generate_launch_description():
#     # Get the launch directory
#     my_nav_dir = get_package_share_directory('dobby_navigation2')
#     my_param_dir = os.path.join(my_nav_dir, 'param')    
#     my_param_file = 'nav2_params.yaml'#src_regulated_pure_pursuit.yaml
#     my_map_dir = os.path.join(my_nav_dir, 'map')
#     my_map_file = 'dobby_map.yaml'
